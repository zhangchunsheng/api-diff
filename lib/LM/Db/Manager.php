...
class Manager {
    ...
    * @param array $servers
    *      array(
    *          "server1" => array("server" => "localhost", "port" => 3306, "username" => 'luomor",
    *                             "password" => "", "db_format" => "%s_%03d", "database_type" => "mysql"),
    "          "server2" => array("server" => "localhost", "port" => 3306, "username" => "luomor",
    *                             "password" => "", "db_format" => "%s_%03d", "database_type" => "mysql"),
    *      )
    * @param array $writeFarms
    *      array(
    *          "default" => "server1", // global
    *          "lm_core" => array( // lm_core_001 lm_core_002 ... lm_core_256
    *              "total" => 256,
    *              "algorithm" => "range",
    *              "servers" => array("1-128" => "server1", "129-256" => "server1")
    *          ),
    *          "lm_crm_common" => array( // lm_crm_common_001 lm_crm_common_002
    *              "total" => 256,
